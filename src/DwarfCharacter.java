...
public class DwarfCharacter extends RPGCharacter {
    private String name;
    ...
    CharacterClass.ClassType chooseClass() {
        return CharacterClass.ClassType.ANAO;
    }
    ...
    String getAbilities() {
        return "Definindo habilidades iniciais: Resistência Anã, Força Poderosa, Habilidade em Armas";
    }

    String getGear() {
        return "Armazenando equipamentos iniciais: Machado de Guerra, Armadura Pesada, Cerveja Artesanal";
    }
